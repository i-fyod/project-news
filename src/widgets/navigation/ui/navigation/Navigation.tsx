    ...
    return (
        <div className={styles.navbar}>
            <nav className={styles.navbar__menu}>
                <Link to="/news" className={styles.navbar__item}>
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path
                                ...
                                stroke={pathName.slice(0, 5) === "/news" ? accentColor : grayColor}
                                strokeWidth="1.5"
                ...
                <Link to="/saved" className={styles.navbar__item}>
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                        <g
                            id="SVGRepo_tracerCarrier"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path
                                ...
                                stroke={pathName === "/saved" ? accentColor : grayColor}
                                strokeWidth="1.5"
                                strokeLinecap="round"></path>{" "}
                            <path
                                d="M15 6H9"
                ...
                <Link to="/profile" className={`${styles.navbar__item} ${styles.navbar__person}`}>
                    <svg
                        viewBox="0 0 32 32"
                        id="Layer_1"
                        xmlns="http://www.w3.org/2000/svg"
                        fill={pathName === "/profile" ? accentColor : grayColor}>
                        <g id="SVGRepo_iconCarrier">
                            <path
                                className="cls-1"
