import { accentColor, grayColor } from "@/shared/const";
...
export function Navigation({ page, setPage }: Props) {
    return (
        <nav className={styles.navbar}>
            <ul className={styles.navbar__menu}>
                    ...
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path
                                ...
                                stroke={page === "main" ? accentColor : grayColor}
                                strokeWidth="1.5"
                    ...
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            <path
                                ...
                                stroke={page === "saved" ? accentColor : grayColor}
                                strokeWidth="1.5"
                                strokeLinecap="round"></path>{" "}
                            <path
                                d="M15 6H9"
                ...
                <li
                    className={`${styles.navbar__item} ${styles.navbar__person}`}
                    onClick={() => setPage("profile")}>
                    <svg
                        viewBox="0 0 32 32"
                        id="Layer_1"
                        xmlns="http://www.w3.org/2000/svg"
                        fill={page === "profile" ? accentColor : grayColor}>
                        <g id="SVGRepo_iconCarrier">
                            <path
                                className="cls-1"
